...
class KLECE(nn.Module):
    ...
    def __init__(self, n_classes=10, coff=1, n_bins=15, confidence_memory_size=50000):
    ...
    def forward(self, input, target):
        ...
        klece = F.cross_entropy(input, target) + self.coff * nn.MSELoss()(predicted_logits, ground_truth_confidence)
        return klece
